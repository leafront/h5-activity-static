  ...
  <div class="scroll-view-wrapper koi_bg" :class="{'visibility': pageView}">
    ...
    <div class="region_second koi_common">
      ...
      <div class="regionSec_body1" v-show="myCouponList.length <= 0">
        ...
        <p class="by1_description">您还没有可用的食运券，快去合成吧！</p>
      </div>
...
.fst_bd_botton {
    ...
    background-image: url("/activity-static/images/queenMergeBotton.jpg");
    background-size: 100%;
    background-repeat: no-repeat;
    color: #8a231c;
    font-weight: bold;
...
.by1_image {
    ...
    background-image: url("/activity-static/images/queenMergefimg.png");
    background-size: 100%;
    background-repeat: no-repeat;
}
.by1_description {
